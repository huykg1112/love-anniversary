...
export default function LoveLetter() {
  ...
  const letterContent = [
    "NYL yêu dấu,",
    "2000 ngày, gần 5 năm và 6 mùa yêu thương đã trôi qua...",
    "Mỗi ngày bên em là một ngày tràn đầy hạnh phúc và ý nghĩa.",
    "Cảm ơn em đã luôn ở bên anh, cùng anh vượt qua những khó khăn và chia sẻ những niềm vui.",
    "Anh yêu em nhiều lắm, và anh hứa sẽ luôn yêu em như vậy mãi mãi.",
    "Chúc mừng 2000 ngày yêu nhau của chúng ta!",
    "Yêu em,",
    "Qy",
  ]
  ...
  return (
    <section className="py-16 relative" ref={letterRef}>
      ...
      >
        <h2 className="text-3xl md:text-5xl font-dancing gradient-text text-center mb-8 section-title">Lời Nhắn Gửi</h2>

        <div className="space-y-4 relative z-10">
          {letterContent.map((line, index) => (
            <motion.p
              key={index}
              className={`text-gray-700 ${index === 0 || index === letterContent.length - 2 || index === letterContent.length - 1 ? "font-dancing text-xl gradient-text" : ""}`}
