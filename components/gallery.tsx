...
const images = [
  ...
  },
  {
    ...
    description:
      "Sinh nhật năm đó là sinh nhật cuối anh được ở bên em, trước khi hai đứa bước vào quãng thời gian yêu xa 😔",
  },
  {
    id: 4,
    src: "/love-anniversary/Gallery/dutrend.jpg",
    alt: "Kỷ niệm 4",
    caption: "Bắt trend mùa dịch COVID",
    description:
      "Không có tiền mua nhẫn nên lấy khẩu trang làm nhẫn rồi sau này đền bằng một đám cưới nha 🤭🤭🤭.",
  },
  {
    id: 5,
    ...
    description:
      "Giáng sinh và sinh nhật của anh, chỉ có hai đứa mình cùng chiếc bánh kem em dành cho anh🎉🎅💖.",
  },
  {
    id: 6,
    src: "/love-anniversary/Gallery/Camping.jpg",
    alt: "Kỷ niệm 6",
    caption: "Đêm cắm trại",
    description:
  ...
  {
    id: 11,
    src: "/love-anniversary/mp4/ky_niem_6_nam.mp4",
    alt: "Kỷ niệm 11",
    caption: "Kỷ niệm 6 năm yêu nhau",
    description:
      "Kỷ niệm 6 năm yêu nhau, một chặng đường dài đầy những kỷ niệm đẹp và ý nghĩa. Cảm ơn em đã luôn bên anh, cùng anh vượt qua mọi thử thách và khó khăn trong cuộc sống. Anh yêu em rất nhiều! ❤️❤️❤️",
    isVideo: true,
  }
];
